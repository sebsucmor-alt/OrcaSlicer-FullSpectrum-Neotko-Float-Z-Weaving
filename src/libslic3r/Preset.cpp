...
static std::vector<std::string> s_Preset_print_options {
    ...
    "interlayer_neoweave_enabled", "interlayer_neoweave_mode", "interlayer_neoweave_amplitude", "interlayer_neoweave_period", "interlayer_neoweave_max_z_speed", "interlayer_neoweave_min_length",
    "monotonic_interlayer_fill",
