...
void TabPrint::build()
{
    ...
    optgroup->append_single_option_line("wall_loops", "strength_settings_walls#wall-loops");
        ...
        optgroup->append_single_option_line("monotonic_interlayer_fill");
        ...
        optgroup = page->new_optgroup(L("Neotko Infill Neoweaving"));
        optgroup->append_single_option_line("infill_neoweave_enabled");
        optgroup->append_single_option_line("infill_neoweave_amplitude");
        optgroup->append_single_option_line("infill_neoweave_period");
        optgroup->append_single_option_line("infill_neoweave_max_z_speed");
